...
def A4azul_CT(document_data):
    ...
    print(
        f'ICMS CDE: {prod_icms_CDE["valor_total"]}, Imp.Som/Dim.: {prod_imp_som_dim["valor_total"]}'
    )
    print(
        ...
        "data": {
            "read": {
                ...
                "leitura": {
                    ...
                    "cons": {"np": consumo_np * 1.025, "fp": consumo_fp * 1.025},
                    "reat": {"np": reativo_np * 1.025, "fp": reativo_fp * 1.025},
                    "reat_exc": {"np": reat_exc_np * 1.025, "fp": reat_exc_fp * 1.025},
                },
                "tarifas": {
                    "demanda_np": {
