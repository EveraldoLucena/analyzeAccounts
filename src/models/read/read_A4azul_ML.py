...
def A4azul_ML(document_data):
    ...
    demanda_contrat_np = document_data['data']['dados']['fatura']['demandas_contratadas'][0]['valor']
    demanda_contrat_fp = document_data['data']['dados']['fatura']['demandas_contratadas'][1]['valor']
    ...
    prod_dem_tusd_fp = func_produto(
        document_data, "Demanda TUSD kW Fora Ponta")
    ...
    print(f'Demanda Contratada NP: {
          demanda_contrat_np}, Demanda Contratada FP: {demanda_contrat_fp}')
    print(f'Demanda Ultrap. NP: {prod_demand_ultrap_np['quantidade']}, Demanda Ultrap. FP: {
          prod_demand_ultrap_fp['quantidade']}')
    ...
    print(f'Tarifa Demanda NP S/Impost: {prod_dem_tusd_np['tarifa_sem_impostos']
                                         }, Tarifa Demanda NP C/Impost: {prod_dem_tusd_np['tarifa_com_impostos']}')
    print(f'Tarifa Demanda FP S/Impost: {prod_dem_tusd_fp['tarifa_sem_impostos']
                                         }, Tarifa Demanda FP C/Impost: {prod_dem_tusd_fp['tarifa_com_impostos']}')
    print(f'Tarifa Demanda Ultrap. NP S/Impost: {prod_demand_ultrap_np['tarifa_sem_impostos']
                                                 }, Tarifa Demanda Ultrap. NP C/Impost: {prod_demand_ultrap_np['tarifa_com_impostos']}')
    print(f'Tarifa Demanda Ultrap. FP S/Impost: {prod_demand_ultrap_fp['tarifa_sem_impostos']
                                                 }, Tarifa Demanda Ultrap. FP C/Impost: {prod_demand_ultrap_fp['tarifa_com_impostos']}')
    print(f'Tarifa Demanda Reativa S/Impost: {prod_demand_reativo_np['tarifa_sem_impostos']
                                              }, Tarifa Demanda Reativa C/Impost: {prod_demand_reativo_np['tarifa_com_impostos']}')
    ...
    print(f'Demanda Reativa NP: {prod_demand_reativo_np['valor_total']}, Demanda Reativa FP: {
          prod_demand_reativo_fp['valor_total']}')
    print(f'Demanda NP: {prod_dem_tusd_np['valor_total']}, Demanda FP: {
          prod_dem_tusd_fp['valor_total']}')
    ...
    print(f'Ajuste Desconto Demand. NP: {ajuste_demand_np['valor_total']}, Ajuste Desconto Demand. FP: {ajuste_demand_fp['valor_total']}, Ajuste Desconto cons.: {ajuste_cons['valor_total']}, Imp.Som/Dim.: {prod_imp_som_dim['valor_total']}')
