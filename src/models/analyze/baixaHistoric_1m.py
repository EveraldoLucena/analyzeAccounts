...
def media_historica_energetico(data_input):
    ...
    account_data = {
        "consumo_np_1m": second_account.get("consumo", {}).get("np", 0),
        "consumo_inter_1m": second_account.get("consumo", {}).get("inter", 0),
    ...
    first_account_data = {
        ...
        "consumo_inter_1m": first_account.get("cons", {}).get("inter", 0),
...
def Branca_energetico(data_input):
    ...
    if (
        ...
        or data["consumo_inter_1m"] > 30
        or data["reativo_inter_1m"] > 30
        or data["consumo_np_1m"] > 30
        or data["reativo_np_1m"] > 30
    ):
        flag_historic = "red"
        ...
        or (15 <= data["consumo_inter_1m"] <= 30)
        or (15 <= data["reativo_inter_1m"] <= 30)
