...
def leitura_alta(input):
    ...
    output = {"demanda": demand_med, "demanda_reativa": demand_reat, "consumo": cons, "reativo": reativo, "geracao": ger}
...
def alta_Historic(json_input, modalidade_tarifaria, tipo_contrato):
